         ...
         <main className="flex-1">
            <div className="container text-center mt-14">
               ...
               <div className="container text-center mt-8 max-w-screen-lg">
                  ...
                  <p className="text-lg mt-2">Sur cette page, tu peux découvrir ton score final et revoir chaque question en détail.
                     Pour chacune, tu verras la bonne réponse ainsi que celle que tu as donnée. Si ta réponse est en rouge, il y a une erreur.</p>
                  <p className="text-lg mt-2">Prends le temps de parcourir tes résultats et devenir incollable pour la prochaine fois. 💪</p>
               ...
               <div className="py-2 px-6 bg-white rounded-lg max-w-screen-lg mx-auto">
                  <Accordion>
                     ...
                     <AccordionPanel>
                        <div className="flex gap-6 items-center mb-4">
                           ...
                           <p className={answersToNumbersArray?.[0] === 1 ? "resTrue" : "resFalse"}>Ta réponse : {answersToNumbersArray?.[0] === 1 ? "Vrai" : "Faux"}</p>
                        </div>
                        <p className="mb-2">
                  ...
                  <Accordion>
                     ...
                     <AccordionPanel>
                        <div className="flex gap-6 items-center mb-4">
                           ...
                           <p className={answersToNumbersArray?.[1] === 1 ? "resTrue" : "resFalse"}>Ta réponse : {answersToNumbersArray?.[1] === 1 ? "Faux" : "Vrai"}</p>
                        </div>
                        <p className="mb-2">
                  ...
                  <Accordion>
                     ...
                     <AccordionPanel>
                        <div className="flex gap-6 items-center mb-4">
                           <p>Bonne réponse : Vrai</p>
                           <p className={answersToNumbersArray?.[2] === 1 ? "resTrue" : "resFalse"}>Ta réponse : {answersToNumbersArray?.[2] === 1 ? "Vrai" : "Faux"}</p>
                        </div>
                        <p className="mb-2">
                  ...
                  <Accordion>
                     ...
                     <AccordionPanel>
                        <div className="flex gap-6 items-center mb-4">
                           <p>Bonne réponse : Faux</p>
                           <p className={answersToNumbersArray?.[3] === 1 ? "resTrue" : "resFalse"}>Ta réponse : {answersToNumbersArray?.[3] === 1 ? "Faux" : "Vrai"}</p>
                        </div>
                        <p className="mb-2">
                  ...
                  <Accordion>
                     ...
                     <AccordionPanel>
                        <div className="flex gap-6 items-center mb-4">
                           <p>Bonne réponse : Faux</p>
                           <p className={answersToNumbersArray?.[4] === 1 ? "resTrue" : "resFalse"}>Ta réponse : {answersToNumbersArray?.[4] === 1 ? "Faux" : "Vrai"}</p>
                        </div>
                        <p className="mb-2">
                  ...
                  <Accordion>
                     ...
                     <AccordionPanel>
                        <div className="flex gap-6 items-center mb-4">
                           <p>Bonne réponse : Faux</p>
                           <p className={answersToNumbersArray?.[5] === 1 ? "resTrue" : "resFalse"}>Ta réponse : {answersToNumbersArray?.[5] === 1 ? "Faux" : "Vrai"}</p>
                        </div>
                        <p className="mb-2">
                  ...
                  <Accordion>
                     ...
                     <AccordionPanel>
                        <div className="flex gap-6 items-center mb-4">
                           <p>Bonne réponse : Vrai</p>
                           <p className={answersToNumbersArray?.[6] === 1 ? "resTrue" : "resFalse"}>Ta réponse : {answersToNumbersArray?.[6] === 1 ? "Vrai" : "Faux"}</p>
                        </div>
                        <p className="mb-2">
                  ...
                  <Accordion>
                     ...
                     <AccordionPanel>
                        <div className="flex gap-6 items-center mb-4">
                           <p>Bonne réponse : Vrai</p>
                           <p className={answersToNumbersArray?.[7] === 1 ? "resTrue" : "resFalse"}>Ta réponse : {answersToNumbersArray?.[7] === 1 ? "Vrai" : "Faux"}</p>
                        </div>
                        <p className="mb-2">
                  ...
                  <Accordion>
                     ...
                     <AccordionPanel>
                        <div className="flex gap-6 items-center mb-4">
                           <p>Bonne réponse : Faux</p>
                           <p className={answersToNumbersArray?.[8] === 1 ? "resTrue" : "resFalse"}>Ta réponse : {answersToNumbersArray?.[8] === 1 ? "Faux" : "Vrai"}</p>
                        </div>
                        <p className="mb-2">
                  ...
                  <Accordion>
                     ...
                     <AccordionPanel>
                        <div className="flex gap-6 items-center mb-4">
                           <p>Bonne réponse : Vrai</p>
                           <p className={answersToNumbersArray?.[9] === 1 ? "resTrue" : "resFalse"}>Ta réponse : {answersToNumbersArray?.[9] === 1 ? "Vrai" : "Faux"}</p>
                        </div>
                        <p className="mb-2">
